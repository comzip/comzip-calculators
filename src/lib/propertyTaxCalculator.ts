 ...
 *
 * 법령 근거(2026-08-05 기준 — 종부세 세율표는 이 날짜에 재정경제부 "2026년
 * 세제개편안" 상세본에 실린 현행법 대비표로 재검증하여 누락됐던 구간을 수정):
 ...
 *    "부동산 > 보유세 계산기 — 재산세" / "— 종합부동산세". 값을 갱신하면
 *    그 문서도 함께 갱신하세요.
 *
...
const COMPREHENSIVE_LOW_BRACKETS: TaxBracket[] = [
  ...
  { upTo: 5_000_000_000, rate: 0.015 }, // ~50억원 1.5%
